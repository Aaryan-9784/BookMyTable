...
function IconStore() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
      <path d="M2 5.5L8 2l6 3.5v8.5a1 1 0 01-1 1H3a1 1 0 01-1-1V5.5z" stroke="#d4af37" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6 15V9h4v6" stroke="#d4af37" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function IconSettings() {
  return (
    <svg width="15" height="15" viewBox="0 0 14 14" fill="none">
      ...
      <path d="M7 1v1.5M7 11.5V13M1 7h1.5M11.5 7H13M2.8 2.8l1.1 1.1M10.1 10.1l1.1 1.1M2.8 11.2l1.1-1.1M10.1 3.9l1.1-1.1" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
...
function IconAnalytics() {
  return (
    <svg width="15" height="15" viewBox="0 0 14 14" fill="none">
      <path d="M1.5 12h11M2.5 9.5l3-3.5 2.5 2 4.5-5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
/* ── AVATAR COMPONENT WITH ONLINE BADGE ────────────────────── */
      ...
      >
        ...
        <div className="px-2 py-2">
          ...
          <Link to="/" onClick={onClose}>
            <MenuItem icon={<IconSwitchView />} label="Switch to Site View" />
          </Link>
        </div>
...
export default function RestaurantNavbar() {
  ...
  const title = Object.entries(PAGE_TITLES).find(([p]) =>
    p === '/restaurant-dashboard' ? pathname === '/restaurant-dashboard' : pathname.startsWith(p)
  )?.[1] ?? 'Dashboard';
  ...
  return (
    ...
    >
      ...
      {/* ── Breadcrumb (Home Icon > Partner Console > Title) ───── */}
