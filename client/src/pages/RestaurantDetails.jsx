          ...
          <div className="flex flex-col justify-between space-y-6">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-sans text-[10px] font-bold uppercase tracking-widest text-luxury-gold">
                    Refundable Token Deposit
                  </p>
                  <p className="font-sans text-2xl font-extrabold text-white">
                    ₹{r.tokenFee ?? 150} <span className="text-xs font-normal text-white/40">/ guest</span>
                  </p>
                </div>
                <div className="text-right text-xs text-white/50">
                  <p>✓ Instant Table Lock</p>
